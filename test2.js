...
// function TextBoxSwap ({navigation}) { 
//   const [fileData1, setText1] = useState(''); 
//   const [fileData2, setText2] = useState(''); 
//   const handleSwap = () => { const temp = fileData1; setText1(fileData2); setText2(temp); }; 
//   return ( <> <TextInput value={fileData1} onChangeText={setText1} /> 
//               <TextInput value={fileData2} onChangeText={setText2} /> 
...
let TextBoxSwap = async(fileData1, fileData2) => { 
  //const [text1, setText1] = useState(''); 
  //const [text2, setText2] = useState(''); 
  const handleSwap = () => { const temp = fileData1; setFileData1(fileData2); setFileData2(temp); }; 
  return ( <> <Text value={fileData2} onChangeText={setFileData1} /> 
              <Text value={fileData1} onChangeText={setFileData2} /> 
              <Button title="Swap" onPress={handleSwap} /> </> 
  ); }; 
function swap(){
    ...
    <ScrollView style={styles.container}>
      ...
      <SafeAreaView style={styles.normal}>
        ...
        <Button
                ...
                //onPress={() => setFileData1(fileData2)}
                onPress={swap}
                //onPress={TextBoxSwap}
...
function HistoryScreen({ navigation }) {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.fixToText}>
      <Text>
        <ReactTimeAgo date={ navigation } locale="en-US"/>
      </Text>
      <TextInput
            scrollEnabled = {true}
            textAlignVertical= 'top'
